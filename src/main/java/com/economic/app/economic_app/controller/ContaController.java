...
import com.economic.app.economic_app.service.ContaService;
...
public class ContaController {
    ...
    public ResponseEntity<Conta> cadastrarConta(@Valid @RequestBody ContaBancariaDTO contaBancariaDTO) {
        Conta novaConta = contaService.cadastrarConta(contaBancariaDTO);
    ...
    public ResponseEntity<List<Conta>> listarContasDoUsuario() {
        List<Conta> contas = contaService.buscarContasPorUsuarioAutenticado();
    ...
    public ResponseEntity<List<Conta>> buscarContasPorInstituicaoFinanceiraContendo(@RequestParam String termo) {
        List<Conta> contas = contaService.buscarContasPorInstituicaoFinanceiraContendo(termo);
        return ResponseEntity.ok(contas);
    }
    ...
    public ResponseEntity<Conta> atualizarConta(@PathVariable String id, 
        ...
        Conta contaAtualizada = contaService.atualizarConta(id, contaBancariaDTO);
